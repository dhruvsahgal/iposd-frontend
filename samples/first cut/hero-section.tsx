      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 lg:px-8 text-center">
        <div className="space-y-10">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 pt-6 animate-fade-in-up [animation-delay:0.6s] opacity-0">
            <Button
              size="lg"
              className="rounded-full px-10 h-14 text-lg font-semibold bg-[var(--ip-teal)] hover:bg-[var(--ip-light-cyan)] text-white transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-[var(--ip-teal)]/50"
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-full px-10 h-14 text-lg font-semibold glass border-[var(--ip-teal)]/40 text-foreground hover:bg-[var(--ip-teal)]/10 hover:border-[var(--ip-teal)] transition-all duration-300 hover:scale-110 bg-transparent"
            >
              Browse experts
            </Button>
          </div>
