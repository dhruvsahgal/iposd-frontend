...
function FeatureCard({ feature, index }: { feature: (typeof features)[0]; index: number }) {
  ...
  return (
    ...
    >
      <div className="p-10 glass border border-foreground/10 hover:border-[var(--ip-teal)]/50 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-[var(--ip-teal)]/20 group rounded-3xl">
