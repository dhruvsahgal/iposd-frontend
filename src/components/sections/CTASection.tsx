      ...
      <div ref={ref} className="max-w-[1200px] mx-auto px-6 lg:px-8 text-center relative z-10">
        <div className="space-y-10">
          ...
          >
            <Link
              href="/assessment"
              className="rounded-full px-12 h-16 text-lg font-bold bg-[var(--ip-teal)] hover:bg-[var(--ip-light-cyan)] text-white transition-all duration-300 hover:scale-110 hover:shadow-2xl hover:shadow-[var(--ip-teal)]/50 group flex items-center justify-center"
            >
            ...
            <Link
              href="/providers"
              className="rounded-full px-12 h-16 text-lg font-bold glass border-[var(--ip-teal)]/40 text-foreground hover:bg-[var(--ip-teal)]/10 hover:border-[var(--ip-teal)] transition-all duration-300 hover:scale-110 flex items-center justify-center"
            >
              Browse experts
            </Link>
          </div>
